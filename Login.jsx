    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-950 text-slate-100 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/60 border border-slate-800 rounded-3xl p-8 backdrop-blur-xl shadow-2xl relative z-10 animate-fade-in">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Track and optimize cloud emissions</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center space-x-2 py-3.5 bg-brand-600 hover:bg-brand-550 active:scale-[0.98] text-white font-bold rounded-2xl transition-all duration-200 disabled:opacity-50 disabled:pointer-events-none shadow-lg shadow-brand-900/30"
          >
            {loading ? (
